...
**Current status: Alaska 2.7.2 splash-separation beta.**
...
- Wider splash-screen title separation with a center divider and small-screen fit protection
...
```text
you-rush-alaska-2.7.2-beta-272-debug.apk
```
