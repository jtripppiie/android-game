 ...
 *
 * Adds a first-pass climbable-tree escape mechanic on top of the existing
 * Alaska runner without rewriting the full core gameplay file yet.
 *
 * Prototype behavior:
 ...
 * - Existing snowball control remains the throw mechanic for bosses.
 */
public class AlaskaSurvivalMooseRushView extends JuicyMooseRushView {
    ...
    private void bindCoreFields() {
        try {
            ...
            Log.d(TAG, "Tree climb field binding ready.");
        } catch (NoSuchFieldException exception) {
            reflectionReady = false;
            Log.w(TAG, "Tree climb field binding failed; visual-only climb fallback active.", exception);
        }
    }
    ...
    private void startTreeClimb() {
        ...
        Log.d(TAG, "Tree climb started: bear/moose escape window active.");
        postInvalidateOnAnimation();
    }
