...
buildConfigField "String", "BUILD_BADGE", '"ALASKA BETA v1.2.5"'
...
```text
1.2.5-beta   current milestone beta test build
1.2.6-beta   next beta fix or tuning build
