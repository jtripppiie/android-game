...
buildConfigField "String", "BUILD_BADGE", '"ALASKA BETA v1.2.7"'
...
```text
1.2.7-beta   current milestone beta test build
1.2.8-beta   next beta fix or tuning build
