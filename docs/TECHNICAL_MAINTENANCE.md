...
```bash
aapt dump badging app/build/outputs/apk/debug/you-rush-alaska-5.0.0-debug.apk
apksigner verify --verbose app/build/outputs/apk/debug/you-rush-alaska-5.0.0-debug.apk
```
