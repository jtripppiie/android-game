...
```bash
aapt dump badging app/build/outputs/apk/debug/you-rush-alaska-5.2.1-debug.apk
apksigner verify --verbose app/build/outputs/apk/debug/you-rush-alaska-5.2.1-debug.apk
```
